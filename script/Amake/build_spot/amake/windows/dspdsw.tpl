...
!!endif!!
!!if valid_name("ldflags_windows")!!
	!!let am_packageldflags=addstring(@am_packageldflags,addstring(" ",@ldflags_windows))!!
!!endif!!
!!if valid_name("arflags_windows")!!
	!!let am_packagearflags=addstring(@am_packagearflags,addstring(" ",@arflags_windows))!!
!!endif!!
...
!!travel package!!
	...
	!!travel libfile!!
		!!let am_packagelibs=multiaddstring(4," ",@name,@am_lib_suffix,@am_packagelibs)!! 
	!!next!!
	!!endif!!
!!next!!
!!leave!!
