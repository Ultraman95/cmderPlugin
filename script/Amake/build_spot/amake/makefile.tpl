...
LDFLAGS=$(AM_LDFLAGES) !!@am_packageldflags!! !!@am_basic_exe_ldflags!! $(MAP_LDFLAGS) $(DEBUG_LDFLAGS) $(PROFILE_LDFLAGS) $(WARNING_LDFLAGS)

LIBARFLAGS=$(AM_ARFLAGES) !!@am_packagearflags!! !!@am_basic_lib_ldflags!! $(MAP_LDFLAGS) $(DEBUG_LDFLAGS) $(PROFILE_LDFLAGS)

DLLARFLAGS=$(AM_ARFLAGES) !!@am_packagearflags!! !!@am_basic_dll_ldflags!! $(MAP_LDFLAGS) $(DEBUG_LDFLAGS) $(PROFILE_LDFLAGS)
...
!!@name!!_lib=!!travel libfile!! !!@am_libinclude!!!!@name!!!!@am_lib_include_suffix!!!!next!!
!!endif!!
!!@name!!_include=!!travel headfile!! !!@am_basedir!!!!@am_dir_convertto!!!!@name!! !!next!!
!!@name!!_includedir=-I!!@am_basedir!!!!@am_dir_convertto!!!!@am_packageincludedir!!!!if valid_name("libfile")!!!!travel libfile!! !!if valid_name("includepath")!! -I!!@includepath!!!!endif!!!!next!!!!endif!!
!!next!!
